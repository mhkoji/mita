  ...
  return (
    <div key="editing" className="input-group">
      ...
      <div className="input-group-append">
        <button className="btn btn-primary" onClick={props.editing.onSave}>
          Save
        </button>
      </div>
    </div>
...
export default function Tag(props) {
  ...
  return (
    <div>
      <Name tag={props.tag} editing={props.editing} />
      <StatefulContents api={props.api} tagId={props.tag.id} />
    </div>
  );
}
