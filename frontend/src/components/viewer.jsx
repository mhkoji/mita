  ...
  render() {
    ...
    const thumbnailEls = thumbnails.map((thumb) => {
      ...
      return (
        ...
        >
          <a href={link}>
            <img alt={image.path} src={image.url} />
          </a>
        </div>
      );
    });
    ...
    return (
      <div className="mita-component-singlevimageviewer">
        <div className="mita-component-singleimageviewer">
          <div
            className="mita-component-singleimageviewer-left"
            style={{ position: "absolute", float: "left" }}
          >
            <div
              className="mita-component-singleimageviewer-image"
          ...
          <div className="mita-component-singleimageviewer-right">
            <div
              ref={this.thumbRef}
              className="mita-component-viewer-thumbnails"
            >
              {thumbnailEls}
              <Progress {...progress} />
            </div>
